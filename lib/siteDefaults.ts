export const DEFAULT_PRIVACY = `우주전자 엠케이전자(이하 '매장')은 고객님의 개인정보를 소중히 여기며, 「개인정보 보호법」에 따라 아래와 같이 처리합니다.
...
본 약관은 우주전자 엠케이전자(이하 '매장')이 제공하는 비대면 상담 신청 서비스(이하 '서비스')의 이용에 관한 조건 및 절차, 매장과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
