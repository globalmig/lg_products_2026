INSERT OR IGNORE INTO site_settings (key, value) VALUES ('privacy_content', 'LG베스트샵 용산전자상가점(이하 ''매장'')은 고객님의 개인정보를 소중히 여기며, 「개인정보 보호법」에 따라 아래와 같이 처리합니다.
...
INSERT OR IGNORE INTO site_settings (key, value) VALUES ('terms_content', '제1조 (목적)
