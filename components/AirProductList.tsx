  ...
  return (
    <section className="bg-[#f5f5f5] py-8 sm:py-10">
      <div className="mx-auto max-w-300 px-5">
        <h2 className="mb-6 text-[18px] font-black tracking-[-0.04em] text-[#1a1a1a] sm:text-[20px] lg:text-[22px]">에어컨/에어케어 베스트</h2>
...
export default function AirProductList() {
  ...
  useEffect(() => {
    productStore.products.getBySection("air").then(setProducts);
    productStore.categories.getBySection("air").then((cats) => setCategories(cats.map((c) => c.name)));
  }, []);
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-300 px-5 py-8 sm:py-10">
        <h2 className="mb-6 text-[18px] font-black tracking-[-0.04em] text-[#1a1a1a] sm:text-[20px] lg:text-[22px]">에어컨/에어케어</h2>
