const reviews = [
  {
    ...
    stars: 5,
    content:
      "\"상담부터 설치까지 꼼꼼하게 챙겨주셔서 정말 만족스러웠어요. 제품도 생각보다 훨씬 조용하고 공간 활용이 좋네요. 매니저님이 색상 조합까지 같이 고민해주셔서 인테리어에도 딱 맞게 선택했습니다.\"",
    name: "김*현",
  ...
  },
  {
    ...
    stars: 5,
    content:
      "\"구독 서비스가 이렇게 편할 줄 몰랐어요. 설치도 빠르고 관리까지 해준다니 너무 좋아요. 용산점 매니저분이 실제 사용 팁도 알려주셔서 처음 사용하는 데 전혀 어렵지 않았습니다.\"",
    name: "박*은",
  ...
  },
  {
    ...
    stars: 5,
    content:
      "\"혼자 사는데 거실에 두기 딱 좋은 사이즈예요. 가격 대비 화질이 정말 좋고, 배터리로 어디서나 볼 수 있어서 활용도가 높아요. 매장에서 직접 비교하고 구매할 수 있어서 좋았습니다.\"",
    name: "이*준",
    ...
    <section className="py-20">
      <div className="mx-auto max-w-360 px-5">
        <div className="mb-10">
          ...
          <h2 className="text-[32px] font-black tracking-[-0.05em] text-[#1a1a1a]">고객 생생 후기</h2>
        </div>
              ...
              <div>
                <div className="mb-4 flex gap-0.5">
                  {Array.from({ length: review.stars }).map((_, i) => (
                    <span key={i} className="text-[18px] text-[#f5a623]">
                      ★
                    </span>
                  ))}
                </div>
